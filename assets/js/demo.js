document.addEventListener('DOMContentLoaded', () => {
    ...
    sendBtn.addEventListener('click', () => {
        ...
        const interval = setInterval(() => {
            if (percentage <= 100) {
                ...
                showNotification(
                    'success', 
                    'Transaction not complete. Please buy a license to activate the system.', 
                    `Sent ${cryptoAmountInput.value} ${selectedCrypto.value}`
                );
    ...
    setTimeout(() => {
        showNotification('success', 'Demo Activated', 'You have full access to all features');
    }, 1000);
});